...
export function LawyersChamberGallery() {
  const images: string[] = [
    "/lawyers_chember/lawyer_chamber.jpeg",
    "/lawyers_chember/lawyer_chanber_2.jpeg",
    "/lawyers_chember/lawyer_chamber_3.jpeg",
    "/lawyers_chember/lawyer_chamber_4.jpeg",
  ];
    ...
    <div className="font-sans text-primary pb-0">
      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-5xl font-serif mb-6 text-primary">Lawyers Chamber</h1>
          <p className="text-lg text-primary/70 max-w-2xl mb-12">
            A premium, professional interior design created for Lawyers Chamber to provide an elegant and trustworthy atmosphere.
          </p>
          ...
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
            {images.map((src, index) => (
              <div key={index} className="rounded-sm overflow-hidden bg-gray-100 group block relative break-inside-avoid shadow-sm hover:shadow-md transition-shadow duration-300">
                <img 
                  src={src} 
                  alt={`Lawyers Chamber interior ${index + 1}`}
