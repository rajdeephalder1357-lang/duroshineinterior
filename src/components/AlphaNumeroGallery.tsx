...
export function AlphaNumeroGallery() {
  const images = [
    "/alpha_numero/alpha_numero (2).jpeg",
    "/alpha_numero/alpha_numero (1).jpeg",
    "/alpha_numero/alpha_numero.jpeg",
    "/alpha_numero/alpha_numero (3).jpeg",
    "/alpha_numero/alpha_numero (5).jpeg",
    "/alpha_numero/alpha_numero (6).jpeg",
    "/alpha_numero/alpha_numero (7).jpeg",
    "/alpha_numero/alpha_numero (8).jpeg",
    "/alpha_numero/alpha_numero (9).jpeg",
  ];
    ...
    <div className="font-sans text-primary pb-0">
      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-5xl font-serif mb-6 text-primary">Alpha Numero</h1>
          <p className="text-lg text-primary/70 max-w-2xl mb-12">
            A showcase of the project we completed for Alpha Numero.
          </p>
          ...
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
            {images.map((src, index) => (
              <div key={index} className="rounded-sm overflow-hidden bg-gray-100 group block relative break-inside-avoid shadow-sm hover:shadow-md transition-shadow duration-300">
                <img 
                  src={src} 
                  alt={`Alpha Numero interior ${index + 1}`}
